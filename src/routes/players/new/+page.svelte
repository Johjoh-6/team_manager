<script lang="ts">
  ...
  <section class="content-grid content-grid justify-center p-4">
	...
	>
		<h1 class="text-3xl font-semibold text-primary-500 text-center">Crée un nouveau joueur</h1>
		<form
		...
		>
            ...
            <label class="label" for="picture">
				<span>Photo du joueur </span><span class="text-token text-xs opacity-85"> (facultatif)</span>
				<input
					type="file"
					id="picture"
					name="picture"
